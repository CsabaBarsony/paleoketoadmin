...
},{"../factory":11,"../helpers/cs":12,"../schemas":13,"../server":14,"react-addons-update":3}],2:[function(require,module,exports){
...
module.exports = {
	...
	food: {
		...
		post: function post(food, callback) {
			...
			debugger;
			if (validation.valid) {
				cs.post('/foods', food, function (status, food) {
					if (status === bella.constants.response.OK) {} else {
						callback();
					}
				});
			} else {
