				...
				list = _.map(this.state.foods, function (food, key) {
					...
					if (_this.state.editingFoodId) {
						if (_this.state.editingFoodId === food.ndbno) {
							...
							show = React.createElement('input', { type: 'checkbox', defaultChecked: food.show, onChange: _this.showChange });
						} else {
							buttons = React.createElement(
								'div',
								null,
							...
							show = React.createElement('input', { type: 'checkbox', defaultChecked: food.show, onChange: _this.showChange, disabled: true });
						}
					} else {
						buttons = React.createElement(
							'div',
